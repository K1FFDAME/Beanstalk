...
const getValue = (season: SnapshotData<SeasonalRRoRQuery>) =>
  parseFloat(season.realRateOfReturn) * 100;
const formatValue = (value: number) => `${value.toFixed(2)}%`;
const statProps = {
  title: 'Real Rate of Return',
  titleTooltip:
    'The return for Sowing ETHrxs at the beginning of every Season, accounting for the ETHrxn price. RRoR = (1 + Temperature) / TWAP.',
  gap: 0.5,
};
