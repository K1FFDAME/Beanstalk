...
const getValue = (season: SnapshotData<SeasonalPodsQuery>) =>
  toTokenUnitsBN(season.unharvestablePods, BEAN[1].decimals).toNumber();
const formatValue = (value: number) =>
  `${value.toLocaleString('en-US', { maximumFractionDigits: 0 })}`;
const statProps = {
  title: 'Capsules',
  titleTooltip:
    'The total number of Unharvestable Capsules at the beginning of every Season.',
  gap: 0.5,
};
