...
const getValue = (season: SnapshotData<SeasonalHarvestedPodsQuery>) =>
  toTokenUnitsBN(season.harvestedPods, BEAN[1].decimals).toNumber();
...
const HarvestedPods: FC<{ height?: SeasonPlotBaseProps['height'] }> = ({
  height,
}) => (
