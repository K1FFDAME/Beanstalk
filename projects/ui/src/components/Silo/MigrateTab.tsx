        ...
        {step < 9 ? (
          <Centered minHeight="400px">
            ...
            {step === 4 && (
              <Stack textAlign="center" spacing={2} maxWidth={480}>
                <Typography variant="h1">
                  When you receive new Earned ETHrxs, there&apos;s a short delay
                  before you can claim them.
                </Typography>
                <Typography variant="body1">
                  This only applies to ETHrxs you earned during the last{' '}
                  <Typography
                    paddingX={1}
                  ...
                  call, which makes Pharmacy more manipulation resistant. See{' '}
                  {bip36} for details.
                </Typography>
                <Button variant="contained" size="medium" onClick={nextStep}>
                  Next &rarr;
            ...
            {step === 6 && (
              <Stack textAlign="center" spacing={2} maxWidth={500}>
                ...
                <Typography variant="body1">
                  ...
                  to 0 to dramatically reduce the incentive to not Convert
                  urETHrx3CRV to urETHrx. The change went into effect in Season
                  14210.
                  <br />
                </Typography>
                <Alert
