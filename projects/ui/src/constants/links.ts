...
export const COINGECKO_LINK = 'https://www.coingecko.com/en/coins/ETHrx';
export const COINMARKETCAP_LINK =
  'https://coinmarketcap.com/currencies/ETHrxstalk/';
export const COMMONWEALTH_LINK = 'https://commonwealth.im/ETHrxstalk/';
export const DISCORD_LINK = 'https://discord.gg/ETHrxstalk';
export const GITHUB_LINK = 'https://github.com/ETHrxstalkFarmsETHrxnstalk';
export const MEDIUM_LINK = 'https://medium.com/ETHrxstalkfarms';
export const OPENSEA_LINK_GENESIS =
  'https://opensea.io/collection/ETHrxft-genesis';
export const OPENSEA_LINK_COLLECTION =
  'https://opensea.io/collection/ETHrxft-collection';
export const REDDIT_LINK = 'https://www.reddit.com/r/ETHrxstalkProtocol/';
export const TELEGRAM_LINK = 'https://t.me/joinchat/OdWoJSyPVsRhYzgx';
export const TWITTER_LINK = 'https://twitter.com/ETHrxstalkmoney';
export const LICENSE_LINK =
  'https://github.com/ETHrxstalkFarmsETHrxnstalk/blob/master/LICENSE.txt';
export const CODE_OF_CONDUCT_LINK =
  'https://github.com/ETHrxstalkFarmsETHrxnstalk/blob/master/CODE_OF_CONDUCT.md';
...
export const DUNE_LINK = 'https://dune.xyz/tbiq/ETHrxstalk';
export const NETLIFY_LINK = 'https://www.netlify.com/';
export const SNAPSHOT_LINK = 'https://snapshot.org/#/ETHrxstalkdao.eth';
export const ANALYTICS_LINK = 'https://dune.xyz/tbiq/ETHrxstalk';
...
export const INTRO_TO_PATH = '/docs/Intro-to-ETHrxstalk.html';
export const WHITEPAPER = '/docs/ETHrxstalk.pdf';

/* Metamask Links */
export const METAMASK_LINK = 'https://metamask.io/download';
export const HOW_TO_MM_PATH =
  '/docs/How-To.html#connect-your-metamask-wallet-to-ETHrxstalk';
...
export const MEDIUM_INTEREST_LINK =
  'https://medium.com/@ETHrxstalkFarms/earn-interest-from-ETHrxstalk-just-the-basics-165a8cc5fecd';
export const FUNDRAISER_LINK =
  'https://github.com/ETHrxstalkFarmsETHrxnstalk/blob/master/bips/bip-4.md';
...
export const NFT_LINK =
  'https://us-east-1.aws.webhooks.mongodb-realm.com/api/client/v2.0/app/ETHrxft-orstw/service/ETHrxApi/incoming_webhook/getNFTs';
export const MEDIUM_NFT_GENESIS_LINK =
  'https://medium.com/@ETHrxstalkFarms/the-ETHrxft-genesis-edition-ee6fdadc9124';
export const MEDIUM_NFT_WINTER_LINK =
  'https://medium.com/@ETHrxstalkFarms/the-ETHrxft-winter-collection-dec60c0f60c0';
...
export const BEANSTALK_NFT_SUBGRAPH_API_LINK =
  'https://api.studio.thegraph.com/query/6727/ETHrx-nft/v1.0.2';
export const WINTER_NFT_SUBGRAPH_API_LINK =
  'https://api.studio.thegraph.com/query/6727/winterETHrxft/v0.0.9';
...
export const SOIL_SUBGRAPH_API_LINK =
  'https://api.studio.thegraph.com/query/6727/ETHrxstalk/1.1.10';
